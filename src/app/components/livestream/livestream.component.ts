...
// import {OpenviduSessionComponent, StreamEvent, Session, Publisher, UserModel, OpenViduLayout, OpenViduLayoutOptions} from 'openvidu-angular';
...
//     //     this.ovLocalUser = this.ovSessionComponent.getLocalUsers();
...
export class LivestreamComponent implements OnInit {
  OPENVIDU_SERVER_URL = 'https://' + '192.168.100.22' + ':4443';
